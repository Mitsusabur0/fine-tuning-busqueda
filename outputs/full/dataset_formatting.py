...
SYS_PROMPT = """
You will receive a `user_input`: a query written in Spanish by a user interacting with an AI assistant on a Chilean real estate/banking platform. Your task is to extract search filters from that `user_input`. These filters apply to the search for properties available for purchase.
Output requirements:
...
Possible_filters = ["tipo_inmueble","comuna","dormitorios","banos","precio_min","precio_max","moneda","superficie_min","superficie_max", "estacionamientos","bodegas","sostenibilidad_certificada","con_subsidio","piscina","areas_verdes","gimnasio","salon_eventos","zona_educacion","zona_transporte","zona_centros_salud"]
Extraction rules:
